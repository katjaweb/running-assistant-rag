...
**Streamlit Application:** The Streamlit app serves as the interface for the Running Assistant, a retrieval-augmented generation (RAG) application designed to answer running-related questions with semantic search.
...
This will generate historical data from the past 6 hours and continiousloy simulate live conversations and feedback.
